...
variable "name" {
  description = "Name ot be used in subnet and secondary names"
  type        = string
}
...
variable "primary_pods_range" {
  description = "Non-RFC1918 CIDR range used for GKE primary pods"
  type        = string
  default     = ""
}


variable "primary_services_range" {
  description = "Non-RFC1918 CIDR range used for GKE primary services"
  type        = string
  default     = ""
}
